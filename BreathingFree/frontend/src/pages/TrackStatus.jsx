...
const TrackStatus = () => {
  ...
  useEffect(() => {
    ...
    const storedUserName =
      localStorage.getItem("userName") || fakeMemberData.name;
    setUserName(storedUserName);

    // Lấy dữ liệu từ localStorage
    const userAge = calculateAge(
      localStorage.getItem("dateOfBirth") || fakeMemberData.dateOfBirth
    );
    const smokeFreeCount = localStorage.getItem("smokeFreeCount") || 0;

    // Lấy avatar mới nhất từ localStorage (ưu tiên profilePicture, sau đó avatar, fallback ảnh mặc định)
    const avatar =
    ...
    const memberData = {
      ...
      dateOfBirth:
        localStorage.getItem("dateOfBirth") || fakeMemberData.dateOfBirth,
      smokingDuration:
        localStorage.getItem("smokingHistory") ||
        fakeMemberData.smokingDuration,
      ...
      chatMessages: [
        {
          id: 1,
          sender: "Dr. Smith",
          message: "Bạn cảm thấy thế nào hôm nay?",
          time: "10:30 AM",
          date: "2023-06-10",
        },
        {
          id: 2,
          sender: "You",
          message: "Tôi cảm thấy tuyệt vời! Không thèm thuốc lá chút nào.",
          time: "10:45 AM",
          date: "2023-06-10",
        },
        {
          id: 3,
          sender: "Dr. Smith",
          message: "Tuyệt vời! Hãy tiếp tục nhé!",
          time: "11:00 AM",
          date: "2023-06-10",
        },
        {
          ...
          sender: "Dr. Smith",
          message:
            "Bạn có trải qua các triệu chứng cai nghiện trong tuần này không?",
          time: "09:15 AM",
          date: "2023-06-12",
        },
        {
          ...
          sender: "You",
          message:
            "Chỉ có một chút đau đầu hôm qua, nhưng nó nhanh chóng qua đi.",
          time: "09:30 AM",
          date: "2023-06-12",
        },
        {
          ...
          sender: "Dr. Smith",
          message:
            "Điều đó bình thường. Hãy đảm bảo uống đủ nước và nghỉ ngơi đầy đủ. Chúng ta sẽ thảo luận thêm các chiến lược trong phiên tới.",
          time: "09:45 AM",
          date: "2023-06-12",
        },
      ],
    ...
    // Listen for avatar/profilePicture changes in localStorage
    const handleStorageChange = () => {
      // Khi localStorage thay đổi, cập nhật lại avatar và memberInfo
      const newAvatar =
        localStorage.getItem("profilePicture") ||
        localStorage.getItem("avatar") ||
        "https://via.placeholder.com/150";
      setMemberInfo((prev) => ({ ...prev, avatar: newAvatar }));
    };
  ...
  const groupedChatMessages = memberInfo.chatMessages.reduce(
    (groups, message) => {
        ...
        >
          <div
            style={{
              ...
              overflow: "hidden",
              background: "#fff",
              boxShadow: "0 2px 12px rgba(44, 144, 133, 0.10)",
              display: "flex",
              alignItems: "center",
          ...
          >
            <img
              src={memberInfo.avatar || "https://via.placeholder.com/150"}
              alt={memberInfo.name}
              style={{
                width: "100%",
                height: "100%",
                      ...
                      >
                        <div
                          style={{
                            maxWidth: "70%",
                            background:
                              message.sender === "You" ? "#35a79c" : "#f0f2f5",
                            color:
                              message.sender === "You" ? "white" : "#2c3e50",
                            padding: "1rem",
                            borderRadius: "15px",
                            position: "relative",
                          }}
          ...
          {activeTab === "achievements" && (
            ...
            >
              ...
              >
                ...
                <p style={{ color: "#7f8c8d" }}>30 ngày không hút thuốc</p>
              </div>
            </div>
          )}
        </div>
