...
/**
 * PatientMonitoringPage - Trang theo dõi bệnh nhân dành cho bác sĩ
 * 
 * Component này hiển thị giao diện theo dõi và quản lý bệnh nhân, bao gồm:
 * - Danh sách bệnh nhân đang được theo dõi
 * - Thông tin tiến độ cai thuốc của từng bệnh nhân
 * - Trạng thái và tình hình hiện tại của bệnh nhân
 * - Các công cụ tìm kiếm và lọc bệnh nhân
 */
        ...
        <div className="patient-monitoring-page">
            ...
            <div className="container py-5">
                ...
                <div className="content-section mt-4">
                    {/* Phần tìm kiếm và lọc bệnh nhân */}
